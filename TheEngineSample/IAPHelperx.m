...
+ (NSDictionary*) getNatureDictionary {
    ...
    NSDictionary *included = [[NSDictionary alloc] initWithObjectsAndKeys:
                           [[NSBundle mainBundle] URLForResource:@"Raining-noise" withExtension:@"m4a"], @"Rain Soft",
                              [[NSBundle mainBundle] URLForResource:@"Rain_Background-Mike_Koenig-1681389445" withExtension:@"m4a"], @"Rain Hard",
                              [[NSBundle mainBundle] URLForResource:@"pinkNoise" withExtension:@"m4a"], @"Noise Pink",
                              [[NSBundle mainBundle] URLForResource:@"whiteNoise" withExtension:@"m4a"], @"Noise White",
                              [[NSBundle mainBundle] URLForResource:@"Birds-chirping-sound-morning-bird-sounds" withExtension:@"m4a"], @"Birds",
                              [[NSBundle mainBundle] URLForResource:@"Cardinal-sounds" withExtension:@"m4a"], @"Cardinals",
                              [[NSBundle mainBundle] URLForResource:@"Frogs-Lisa_Redfern-1150052170" withExtension:@"m4a"], @"Frogs",
                              [[NSBundle mainBundle] URLForResource:@"rainforest_ambience-GlorySunz-1938133500" withExtension:@"m4a"], @"Rainforest",
                              [[NSBundle mainBundle] URLForResource:@"60507_juskiddink_waves" withExtension:@"m4a"], @"Waves Lake",
                              [[NSBundle mainBundle] URLForResource:@"Heart_Beat-Zarabadeu-1492122436" withExtension:@"m4a"], @"Heartbeat",
                              [[NSBundle mainBundle] URLForResource:@"184731_corsica-s_2013-04-12-falls-creek-falls" withExtension:@"m4a"], @"Falls Deep",
                              [[NSBundle mainBundle] URLForResource:@"194478__inchadney__northsea-denmark" withExtension:@"m4a"], @"Waves Sea",
                              [[NSBundle mainBundle] URLForResource:@"162786_mark-ian_cricketfx" withExtension:@"m4a"], @"Crickets",
*/
    NSDictionary *included = [[NSDictionary alloc] initWithObjectsAndKeys:
                              rainSoft, @"Rain Soft",
                              rainHard, @"Rain Hard",
    ...
    /*
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"brownNoise.m4a"]]], @"Noise Brown",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"16480__martin-lightning__severe-thunderstorm.m4a"]]], @"Thunderstorm",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"28657_corsica-s_latourelle-falls-in-winter.m4a"]]], @"Falls Medium",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"38569__digifishmusic__atherton-tablelands-malanda-falls.m4a"]]], @"Falls Bright",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"117191__1jmorrisoncafe291__waterfall-1.m4a"]]], @"Falls Mid",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"124698_inchadney_waterfall-in-the-harz-mountains.m4a"]]], @"Falls Soft",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"127840_martats_waterfall-cycle.m4a"]]], @"Falls Hiss",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"128049_martats_big-waterfall.m4a"]]], @"Falls Rage",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"187356_pashee_street-ambience-in-china.m4a"]]], @"City China",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"191695_fridobeck_water.m4a"]]], @"River",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"194898__thaighaudio__072013-chicago-skyline-facing-south-above-ohio-st.m4a"]]], @"City Chicago",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"196699__vonfleisch__river-running-water.m4a"]]], @"Stream",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"204845__corsica-s__seaside-cove-waves.m4a"]]], @"Waves Cove",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"217506__felix-blume__wind-blowing-in-a-field-in-texas-usa.m4a"]]], @"Wind",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"250770_ninafoletti_river-waterfall-2.m4a"]]], @"Falls River",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"251981_jillismolenaar_gentle-surf-rolling-on-sandy.m4a"]]], @"Waves Light",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"320306_sophronsinesounddesign_beach-9.m4a"]]], @"Waves Beach",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Chickadee.m4a"]]], @"Chickadee",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Rain-falling-on-balcony-roof-birds-singing-in-the-background.m4a"]]], @"Rain Balcony",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Rain-falling-sound.m4a"]]], @"Rain Woods",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Sleep-sounds-rain.m4a"]]], @"Rain Patter",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Wetlands-SoundBible.com-1972469419.m4a"]]], @"Wetlands",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Natural-bird-sounds.m4a"]]], @"Birds Forest",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Night-Sounds-scops-owl.m4a"]]], @"Owl",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"Rain-falling-bird-sound-in-background.m4a"]]], @"Rain Birds",
//[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@""]]], @"",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"48936_dobroide_20060221-box-fan-fast.m4a"]]], @"Box Fan Fast",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"51833_timdrussell_boxfan.m4a"]]], @"Boxfan",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"186706_qubodup_gray-noise.m4a"]]], @"Noise Gray",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"186708_qubodup_blue-noise.m4a"]]], @"Noise Blue",
[[NSURL alloc] initFileURLWithPath:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"186707_qubodup_purple-noise.m4a"]]], @"Noise Purple",
                    */
                           nil];
...
+ (NSMutableArray*) getAudioMatrix:(NSString*)trackId
{
    ...
    if([trackId isEqualToString:@"sleep"])  {
        ...
        [audioMatrix insertObject:[NSMutableArray arrayWithObjects:
                                   ...
                                   [NSNumber numberWithFloat:1.5f],                 //binaural for gap
                                   [NSNumber numberWithInteger:120],nil] atIndex:11]; //gap length
        ...
        [audioMatrix insertObject:[NSMutableArray arrayWithObjects:
                                   ...
                                   [NSNumber numberWithFloat:172.06],                //carrier for gap
                                   [NSNumber numberWithFloat:4.9f],                 //binaural for gap
                                   [NSNumber numberWithInteger:60],nil] atIndex:18]; //gap length
